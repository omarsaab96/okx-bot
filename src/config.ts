...
export const config = {
  ...
  bot: {
    ...
    marketType: (process.env.BOT_MARKET_TYPE || "SPOT") as "SPOT" | "SWAP",
    mgnMode: (process.env.MGN_MODE || "cross") as "cross" | "isolated",
    positionMode: (process.env.POSITION_MODE || "net") as "net" | "hedge",
